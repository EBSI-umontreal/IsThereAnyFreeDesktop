...
<body>
    <div class="stats-layout">
        <aside class="stats-sidebar" aria-label="Navigation des statistiques">
            <div class="stats-brand">
                <span class="stats-brand-mark">Statistiques</span>
            </div>
            <nav class="stats-nav">
                <a href="#en-direct" class="stats-nav-link is-active">En direct</a>
                <a href="#aujourdhui" class="stats-nav-link">Aujourd'hui</a>
                <a href="#journee-selectionnee" class="stats-nav-link">Journée sélectionnée</a>
                <a href="#session-academique" class="stats-nav-link">Session académique</a>
                <a href="#comparaison" class="stats-nav-link">Comparaison</a>
                <a href="#historique-poste" class="stats-nav-link">Historique d'un poste</a>
                <a href="#sessions-utilisateur" class="stats-nav-link">Sessions d'un utilisateur</a>
            </nav>
        </aside>
        <main class="stats-main">
            ...
            <h1 id="en-direct">En direct</h1>

            <div class="zone-graphe">
                <div class="stats-tabs stats-tabs-realtime">
                    <div class="tabs-nav">
                        <button type="button" class="tab-btn is-active" data-tab="presentation">Présentation</button>
                    ...
                    <div class="tab-panel is-active" data-panel="presentation">
                        <div class="cartes">
                    ...
                    <div class="tab-panel" data-panel="json">
                        <pre id="jsonRealtime" class="json-view"></pre>
                    </div>
                    <div class="tab-panel" data-panel="api">
                        <div class="api-request">
                            <div class="api-request-label">Requête HTTP utilisée</div>
                            <code id="apiRealtimeRequest">GET api.php?tempsreel=1</code>
                            <button type="button" class="api-copy-btn" data-copy-target="apiRealtimeRequest">Copier la requête</button>
                            <button type="button" class="api-open-btn" data-api-url="api.php?tempsreel=1">Ouvrir dans un onglet</button>
                            <small id="apiRealtimeCopyStatus" class="api-copy-status" aria-live="polite"></small>
                        </div>
                    </div>
                </div>
            </div>

            <h1 id="aujourdhui">Aujourd'hui</h1>

            <div class="zone-graphe">
                <div class="cartes">
                    <div class="carte"><div class="titre">Sessions totales</div><div id="td_nb_sessions" class="valeur">-</div></div>
                    <div class="carte"><div class="titre">Durée totale (heures)</div><div id="td_duree_totale_h" class="valeur">-</div></div>
                    <div class="carte"><div class="titre">Durée moyenne (minutes)</div><div id="td_duree_moy_min" class="valeur">-</div></div>
                    <div class="carte"><div class="titre">Taux d'occupation (24 h)</div><div id="td_taux_occupation_24h" class="valeur">-</div></div>
                </div>
                <small id="td_asof"></small>
                ...
                <div class="stats-tabs">
                    ...
                    <div class="tab-panel is-active" data-panel="graph">
                        <canvas id="todayHoursChart" height="90"></canvas>
                    </div>
                    <div class="tab-panel" data-panel="table">
                        <div class="tab-table-wrap">
                            <table>
                                ...
                                <tbody id="tbodyTodayStatsHour"></tbody>
                            </table>
                        </div>
                    </div>
                    <div class="tab-panel" data-panel="json">
                        <pre id="jsonTodayStatsHour" class="json-view"></pre>
                    </div>
                </div>
            </div>

            <h1 id="journee-selectionnee">Journée sélectionnée</h1>

            <div class="zone-graphe">
                <div class="filtres">
                    <label>Date
                        <input type="date" id="selectedDayDate" value="<?php echo $today; ?>" />
                    </label>
                    <button type="button" id="btnSelectedDayPrev" title="Journée précédente">&lt;</button>
                    <button type="button" id="btnSelectedDayNext" title="Journée suivante">&gt;</button>
                </div>
                <div class="cartes">
                    <div class="carte"><div class="titre">Sessions totales</div><div id="sd_nb_sessions" class="valeur">-</div></div>
                    <div class="carte"><div class="titre">Durée totale (heures)</div><div id="sd_duree_totale_h" class="valeur">-</div></div>
                    <div class="carte"><div class="titre">Durée moyenne (minutes)</div><div id="sd_duree_moy_min" class="valeur">-</div></div>
                    <div class="carte"><div class="titre">Taux d'occupation (24 h)</div><div id="sd_taux_occupation_24h" class="valeur">-</div></div>
                </div>
                <small id="sd_asof"></small>
                ...
                <div class="stats-tabs">
                    ...
                    <div class="tab-panel is-active" data-panel="graph">
                        <canvas id="selectedDayHoursChart" height="90"></canvas>
                    </div>
                    <div class="tab-panel" data-panel="table">
                        <div class="tab-table-wrap">
                            <table>
                                ...
                                <tbody id="tbodySelectedDayStatsHour"></tbody>
                            </table>
                        </div>
                    </div>
                    <div class="tab-panel" data-panel="json">
                        <pre id="jsonSelectedDayStatsHour" class="json-view"></pre>
                    </div>
                </div>
            </div>

            <h1 id="session-academique">Statistiques par session académique</h1>
            ...
            <h1 id="comparaison">Comparaison de sessions</h1>
            ...
            <div class="zone-graphe">
                ...
                <label class="cmp-overlay-opt">
                    ...
                    Superposer par indice de session (Jour 1, Jour 2, etc.)
                </label>
            ...
            <h1 id="historique-poste">Historique d'un poste</h1>
            ...
            <div class="zone-graphe">
                <div class="history-ctrl">
                    ...
                    <button type="button" id="btnHistoryPrev" title="Journée précédente">&lt;</button>
                    <button type="button" id="btnHistoryNext" title="Journée suivante">&gt;</button>
                </div>
                ...
                <div class="stats-tabs stats-tabs-history">
                    ...
                    <div class="tab-panel" data-panel="api">
                        <div class="api-request">
                            <div class="api-request-label">Requête HTTP utilisée</div>
                            <code id="apiRequest-history">api.php?historiqueposte=1&amp;poste=POSTE&amp;date=YYYY-MM-DD</code>
                            <button type="button" class="api-copy-btn" data-copy-target="apiRequest-history">Copier la requête</button>
                            <button type="button" class="api-open-btn" data-api-url="api.php?historiqueposte=1&amp;poste=POSTE&amp;date=YYYY-MM-DD">Ouvrir dans un onglet</button>
                            <small id="apiCopyStatus-history" class="api-copy-status" aria-live="polite"></small>
                        </div>
                    </div>
                </div>
            </div>

            <h1 id="sessions-utilisateur">Sessions d'un utilisateur</h1>
